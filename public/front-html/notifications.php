...
<section class="weekly-section">
    <div class="container bg-colored">
                ...
                <nav class="nav nav-borders">
                    <a class="nav-link active ms-0" href="add-user.php">Profile</a>
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="p-0 card-body"><a class="notification border-x-0 border-bottom-0 border-300 rounded-0"
                            ...
                            <div class="notification-body">
                                <p class="mb-1"><strong>Rowan Atkinson</strong> Tagged <strong>Anthony Hopkins</strong>
                            ...
                            <div class="notification-body">
                                <p class="mb-1"><strong>Robert Downey</strong> mention <strong>Anthony Hopkins</strong>
