            ...
            @foreach ($region_2_column_configuration as $region_2_column_configuration_item)
                @if ($region_2_column_configuration_item->visibility)
                    ...
                    @elseif($region_2_column_configuration_item->column == 'wt_pc')
                        ...
                        @if (Auth::user()->role == 1)
                            <td class="toggleable-1" id="{{ $data_target }}">
                                <input class="text-w" type="text" step="any" name="wt_pc" id="wt_pc"
            ...
            @if (Auth::user()->role == 1)
                ...
                <td class="toggleable-2">
                    <input type="number" step="any" name="price" id="price"
                        ...
                        onkeyup="sendAjaxRequest('price', this.value, event)" oninput="preventNegativeValue(this)">
                </td>
                <td class="toggleable-2">
                    <textarea class="text-w" name="notes" id="notes" value="{{ $data->notes }}" data-id="{{ $data->id }}"
