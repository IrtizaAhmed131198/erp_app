        ...
        @if (Auth::user()->View_2 == 1)
            ...
            @foreach ($region_2_column_configuration as $region_2_column_configuration_item)
                @if ($region_2_column_configuration_item->visibility)
                    ...
                    @elseif($region_2_column_configuration_item->column == 'order_notes')
                        ...
                        @if (Auth::user()->role == 1)
                            <td class="toggleable-1" id="{{ $data_target }}">
                                <textarea name="part_notes" id="order_notes" value="{{ $data->order_notes }}" data-id="{{ $data->id }}"
                ...
                @foreach ($region_2_column_configuration as $region_2_column_configuration_item)
                    @if ($region_2_column_configuration_item->visibility)
                        ...
                        @elseif($region_2_column_configuration_item->column == 'live_inventory_wip')
                            ...
                            @if (Auth::user()->role == 1)
                                <td class="toggleable-1" id="{{ $data_target }}">
                                    <input type="number" step="any" name="live_inventory_wip"
                                        id="live_inventory_wip" value="{{ $data->live_inventory_wip }}"
                                        data-id="{{ $data->id }}"
                                        onkeyup="sendAjaxRequest('live_inventory_wip', this.value, event)"
                                        oninput="preventNegativeValue(this)">
                                </td>
                            @else
                                <td class="toggleable-1" id="{{ $data_target }}">{{ $data->live_inventory_wip }}
                                </td>
                            @endif
                        @elseif($region_2_column_configuration_item->column == 'in_process_out_side')
                            @php
                        ...
                        @elseif($region_2_column_configuration_item->column == 'wt_pc')
                            ...
                            @if (Auth::user()->role == 1)
                                <td class="toggleable-1" id="{{ $data_target }}">
                                    <input class="text-w" type="text" step="any" name="wt_pc"
                                        id="wt_pc" value="{{ $data->wt_pc }}" data-id="{{ $data->id }}"
                        ...
                        @elseif($region_2_column_configuration_item->column == 'order_notes')
                            ...
                            @if (Auth::user()->role == 1)
                                <td class="toggleable-1" id="{{ $data_target }}">
                                    <textarea class="text-w" name="part_notes" id="order_notes" value="{{ $data->order_notes }}"
                                        data-id="{{ $data->id }}" onkeyup="sendAjaxRequest('order_notes', this.value, event)" cols="50">{{ $data->order_notes }}</textarea>
                                </td>
                            @else
                                <td class="toggleable-1" id="{{ $data_target }}">{{ $data->order_notes }}</td>
                            @endif
                        @elseif($region_2_column_configuration_item->column == 'part_notes')
                            ...
                            @if (Auth::user()->role == 1)
                                <td class="toggleable-1" id="{{ $data_target }}">
                                    <textarea class="text-w" name="part_notes" id="part_notes" class="simple-textarea"
            ...
            @if (Auth::user()->View_3 == 1)
                ...
                @if (Auth::user()->role == 1)
                    ...
                    <td class="toggleable-2">
                        <textarea class="text-w" name="notes" id="notes" value="{{ $data->notes }}"
